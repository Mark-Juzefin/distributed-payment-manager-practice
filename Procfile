...
cdc: set -a && source env/common.env && source env/endpoints.host.env && source env/cdc.env && set +a && go run ./cmd/cdc
analytics: set -a && source env/common.env && source env/endpoints.host.env && source env/analytics.env && set +a && go run ./cmd/analytics
