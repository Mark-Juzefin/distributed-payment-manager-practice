...
-- Висновки - завдяки тому що з самого початку арзітектура рішення будувалася максимально розширюваним чином:
- пізніше було легко додати обгортку для dlq, retry 
- перемикання режимів цечез env. 
- маштабуванян консюмерів
