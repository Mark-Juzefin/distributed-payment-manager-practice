...
import (
	...
	"TestTaskJustPay/services/api/domain/order"
	"TestTaskJustPay/services/api/external/silvergate"
	"TestTaskJustPay/services/api/handlers"
	"TestTaskJustPay/services/api/handlers/updates"
	dispute_repo "TestTaskJustPay/services/api/repo/dispute"
	"TestTaskJustPay/services/api/repo/dispute_eventsink"
	events_repo "TestTaskJustPay/services/api/repo/events"
	order_repo "TestTaskJustPay/services/api/repo/order"
	"TestTaskJustPay/services/api/repo/order_eventsink"
)
