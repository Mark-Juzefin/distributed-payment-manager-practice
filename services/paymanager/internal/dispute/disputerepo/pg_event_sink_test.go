...
func TestPgEventRepo_buildDisputeEventPageQuery(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			expectedArgs: []any{"dispute_1", "dispute_2"},
		},
		{
			...
			expectedArgs: []any{"dispute_1", dispute.DisputeEventWebhookOpened, dispute.DisputeEventEvidenceAdded},
		},
		{
			...
			expectedArgs: []any{"dispute_1", testTime.UTC(), testTime.Add(24 * time.Hour).UTC()},
		},
		{
			...
			expectedArgs: []any{"dispute_1", testTime.UTC(), "event_123"},
		},
		{
