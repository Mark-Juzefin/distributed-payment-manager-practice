...
func NewEventSink(db postgres.Executor, readDB postgres.Executor, builder squirrel.StatementBuilderType) *PgOrderEventRepo {
...
func (r *PgOrderEventRepo) buildOrderEventPageQuery(q order.OrderEventQuery) (string, []any, error) {
